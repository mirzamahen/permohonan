          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Permohonan Magang/PKL</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="submit_magang.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="pdf_surat">Upload Surat Izin/Permohonan Magang/PKL</label>
                      <div class="custom-file">
                  ...
                  <div class="form-group">
                    <label for="proposal_surat">Upload Proposal Magang/PKL</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="pdf_proposal" id="pdf_proposal" accept="application/pdf" required>
                        <label class="custom-file-label" for="pdf_surat">Upload Proposal Anda Disini</label>
                      </div>
                  </div>
                </div>
                <!-- /.card-body -->
