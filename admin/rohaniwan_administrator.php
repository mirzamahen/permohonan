                      ...
                      <tbody>
                          <?php
                            ...
                            while ($row = $result->fetch_assoc()) {
                              ...
                              echo "<td>" . $row['status_penjemputan'] . "</td>";
                              echo "<td>" . $row['tracking_number'] . "</td>";
                              echo "<td><a href='" . $row['rohaniwan_path'] . "' target='_blank'><i class='fa-solid fa-eye'></i></a></td>";
                ...
                <div class='modal-dialog'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h5 class='modal-title' id='editModalLabel" . $row_modal['id'] . "'>Edit Status</h5>
                            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                            </button>
                        </div>
                        <form action='edit_status_rohaniwan_administrator.php' method='post'>
