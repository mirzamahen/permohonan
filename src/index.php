    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-4">
            <div class="card">
              <img src="adminlte/dist/img/intership.png" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title"><b>PERMOHONAN MAGANG/PKL</b></h5>
                <p class="card-text">Syarat:</p>
                <ul class="card-text">
                  <li>Surat Pengantar Ijin dari institusi/instansi asal tertuju kepada Kepala Kantor Wilayah Kementerian Agama DIY</li>
                  <li>Proposal Magang</li>
                  <li>Kartu identitas yang masih berlaku</li>
                </ul>
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="adminlte/dist/img/penelitian.png" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title"><b>PERMOHONAN PENELITIAN</b></h5>
                <p class="card-text">Syarat:</p>
                <ul class="card-text">
                  <li>Surat Pengantar Ijin dari institusi/instansi asal tertuju kepada Kepala Kantor Wilayah Kementerian Agama DIY</li>
          ...
          <div class="col-md-4">
            <div class="card">
              <img src="adminlte/dist/img/sumpah.png" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title"><b>PERMOHONAN ROHANIWAN</b></h5>
                <p class="card-text">Syarat:</p>
                <ul class="card-text">
                  <li>Surat Permohonan Permintaan Rohaniwan dari institusi/instansi asal tertuju kepada Kepala Kantor Wilayah Kementerian Agama DIY</li>
                  <li>Kartu identitas yang masih berlaku</li>
                  <br>
                </ul>
                <a href="#" class="btn btn-primary">Ajukan Permohonan</a>
