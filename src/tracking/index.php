          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-2"><b>Magang/PKL</b></h5>
                <p class="card-text"><br>Cari tau proses permohonanmu untuk Magang atau PKL.</p>
                <a href="magang.php" class="btn btn-primary">Cari</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-2"><b>Penelitian</b></h5>
                <p class="card-text"><br>Cari tau proses permohonanmu untuk kegiatan penelitian.</p>
                <a href="penelitian.php" class="btn btn-primary">Cari</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card">
              <div class="card-body text-center">
                ...
                <h5 class="card-title mt-2"><b>Rohaniwan</b></h5>
                <p class="card-text"><br>Cari tau proses permohonanmu untuk layanan rohaniwan.</p>
                <a href="rohaniwan.php" class="btn btn-primary">Cari</a>
              </div>
            </div>
          </div>
          <!--/.col -->
