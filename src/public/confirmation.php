...
<head>
    ...
    <title>Konfirmasi Permohonan</title>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12 text-center">
                    ...
                    <p>Permohonan Anda Telah berhasil Dikirim. Nomor Tracking Permohonan Anda adalah:
                       <br><b> <?php echo htmlspecialchars($_GET['tracking_number']); ?></b>
                       <br>
                            Silahkan Simpan Nomor Tracking Tersebut Untuk Mengetahui Proses Permohonan Anda</p>
