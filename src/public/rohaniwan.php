          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Permohonan Rohaniwan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="submit_rohaniwan.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="123@gmail.com" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <select class="form-control" name="status_penjemputan" id="status_penjemputan" required>
                          <option value="" disabled selected>Pilih Status Penjemputan</option>
                          <option value="Rohaniwan Dijemput">Rohaniwan Dijemput</option>
                          <option value="Rohaniwan Tidak Dijemput">Rohaniwan Tidak Dijemput</option>
                      </select>
                  </div>
                  <div class="form-group">
                    <label for="pdf_rohaniwan">Upload Surat Permohonan</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="pdf_rohaniwan" id="pdf_rohaniwan" accept="application/pdf" required>
                        <label class="custom-file-label" for="pdf_rohaniwan">Upload Disini</label>
                      </div>
                  </div>
                </div>
                <!-- /.card-body -->
